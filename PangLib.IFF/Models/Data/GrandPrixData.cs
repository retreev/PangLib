...
namespace PangLib.IFF.Models.Data
{
    ...
    public class GrandPrixData
    {
        ...
        public string Name { get => Encoding.UTF7.GetString(NameInBytes).Replace("\0", ""); set => NameInBytes = Encoding.UTF7.GetBytes(value.PadRight(66, '\0')); }
        ...
        public string Info { get => Encoding.UTF7.GetString(InfoBytes).Replace("\0", ""); set => InfoBytes = Encoding.UTF7.GetBytes(value.PadRight(516, '\0')); }
