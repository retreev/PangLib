...
namespace PangLib.IFF.JP.Extensions
{
    ...
    public class sIFFHandle
    {
        ...
        public IFFFile<CounterItem> m_counter_item;
        ...
        public IFFFile<ClubSetWorkShopLevelUpProb> m_club_set_work_shop_level_up_prob;
        public IFFFile<ClubSetWorkShopRankUpExp> m_club_set_work_shop_rank_exp;
        public IFFFile<Course> m_course;
        public IFFFile<CutinInformation> m_cutin_infomation;
        ...
        public IFFFile<GrandPrixAIOptionalData> m_grand_prix_ai_optinal_data;
        public IFFFile<GrandPrixConditionEquip> m_grand_prix_condition_equip;
        public IFFFile<GrandPrixData> m_grand_prix_data;
        public IFFFile<MemorialShopCoinItem> m_memorial_shop_coin_item;
        public IFFFile<ArtifactManaInfo> m_artifact_mana_info;
        public IFFFile<ErrorCodeInfo> m_error_code_info;
        public IFFFile<HoleCupDropItem> m_hole_cup_drop_item;
        public IFFFile<LevelUpPrizeItem> m_level_up_prize_item;
        public IFFFile<NonVisibleItemTable> m_non_visible_item_table;
        public IFFFile<PointShop> m_point_shop;
        public IFFFile<ShopLimitItem> m_shop_limit_item;
        public IFFFile<SpecialPrizeItem> m_special_prize_item;
        public IFFFile<SubscriptionItemTable> m_subscription_item_table;
        ...
        public IFFFile<TimeLimitItem> m_time_limit_item;
        public IFFFile<AddonPart> m_addon_part;
        public IFFFile<CadieMagicBox> m_cadie_magic_box;
        public IFFFile<CadieMagicBoxRandom> m_cadie_magic_box_random;
        public IFFFile<CharacterMastery> m_character_mastery;
        public IFFFile<ClubSetWorkShopLevelUpLimit> m_club_set_work_shop_level_up_limit;
        ...
        public IFFFile<CaddieVoiceTable> m_caddie_voice_table;
        public IFFFile<FurnitureAbility> m_furniture_ability;
        public IFFFile<TwinsItemTable> m_twins_item_table;
...
sIFFHandle()
        ...
        public void UpdateIFF()
        {
            ...
            UpdateField(m_part, "Part.iff", ref count_update);
            UpdateField(m_item, "Item.iff", ref count_update);
            UpdateField(m_set_item, "SetItem.iff", ref count_update);
            UpdateField(m_mascot, "Mascot.iff", ref count_update);
            UpdateField(m_achievement, "Achievement.iff", ref count_update);
            UpdateField(m_counter_item, "CounterItem.iff", ref count_update);
            UpdateField(m_quest_stuff, "QuestStuff.iff", ref count_update);
            UpdateField(m_quest_item, "QuestItem.iff", ref count_update);
            UpdateField(m_aux_part, "AuxPart.iff", ref count_update);
            UpdateField(m_ball, "Ball.iff", ref count_update);
            UpdateField(m_caddie, "Caddie.iff", ref count_update);
            UpdateField(m_caddie_item, "CaddieItem.iff", ref count_update);
            UpdateField(m_card, "Card.iff", ref count_update);
            UpdateField(m_character, "Character.iff", ref count_update);
            UpdateField(m_club, "Club.iff", ref count_update);
            UpdateField(m_club_set, "ClubSet.iff", ref count_update);
            UpdateField(m_club_set_work_shop_level_up_prob, "ClubSetWorkShopLevelUpProb.iff", ref count_update);
            UpdateField(m_club_set_work_shop_rank_exp, "ClubSetWorkShopRankUpExp.iff", ref count_update);
            UpdateField(m_course, "Course.iff", ref count_update);
            UpdateField(m_cutin_infomation, "CutinInformation.iff", ref count_update);
            UpdateField(m_enchant, "Enchant.iff", ref count_update);
            UpdateField(m_furniture, "Furniture.iff", ref count_update);
            UpdateField(m_hair_style, "HairStyle.iff", ref count_update);
            UpdateField(m_match, "Match.iff", ref count_update);
            UpdateField(m_skin, "Skin.iff", ref count_update);
            UpdateField(m_ability, "Ability.iff", ref count_update);
            UpdateField(m_desc, "Desc.iff", ref count_update);
            UpdateField(m_grand_prix_ai_optinal_data, "GrandPrixAIOptionalData.iff", ref count_update);
            UpdateField(m_grand_prix_condition_equip, "GrandPrixConditionEquip.iff", ref count_update);
            UpdateField(m_grand_prix_data, "GrandPrixData.iff", ref count_update);
            UpdateField(m_memorial_shop_coin_item, "MemorialShopCoinItem.sff", ref count_update);
            UpdateField(m_artifact_mana_info, "ArtifactManaInfo.iff", ref count_update);
            UpdateField(m_error_code_info, "ErrorCodeInfo.iff", ref count_update);
            UpdateField(m_hole_cup_drop_item, "HoleCupDropItem.iff", ref count_update);
            UpdateField(m_level_up_prize_item, "LevelUpPrizeItem.iff", ref count_update);
            UpdateField(m_non_visible_item_table, "NonVisibleItemTable.iff", ref count_update);
            UpdateField(m_point_shop, "PointShop.iff", ref count_update);
            UpdateField(m_shop_limit_item, "ShopLimitItem.iff", ref count_update);
            UpdateField(m_special_prize_item, "SpecialPrizeItem.iff", ref count_update);
            UpdateField(m_subscription_item_table, "SubscriptionItemTable.iff", ref count_update);
            UpdateField(m_set_effect_table, "SetEffectTable.iff", ref count_update);
            ...
            UpdateField(m_cadie_magic_box, "CadieMagicBox.iff", ref count_update);
            UpdateField(m_cadie_magic_box_random, "CadieMagicBoxRandom.iff", ref count_update);
            UpdateField(m_character_mastery, "CharacterMastery.iff", ref count_update);
            UpdateField(m_club_set_work_shop_level_up_limit, "ClubSetWorkShopLevelUpLimit.iff", ref count_update);
            UpdateField(m_grand_prix_rank_reward, "GrandPrixRankReward.iff", ref count_update);
            UpdateField(m_grand_prix_special_hole, "GrandPrixSpecialHole.iff", ref count_update);
            UpdateField(m_memorial_shop_rare_item, "MemorialShopRareItem.iff", ref count_update);
            UpdateField(m_caddie_voice_table, "CaddieVoiceTable.iff", ref count_update);
            UpdateField(m_furniture_ability, "FurnitureAbility.iff", ref count_update);
            UpdateField(m_twins_item_table, "TwinsItemTable.iff", ref count_update);
