...
| [**PangLib.Utilities**](PangLib.Utilities/)   | [![Nuget](https://img.shields.io/nuget/v/PangLib.Utilities.svg)](https://www.nuget.org/packages/PangLib.Utilities/)   | [![Build status](https://github.com/retreev/panglib/actions/workflows/utilities-build.yaml/badge.svg)](https://github.com/retreev/PangLib/actions/workflows/utilities-build.yaml) | Common utilities used in other `PangLib` libraries          |
| [**PangLib.WEP**](PangLib.WEP/)               | [![Nuget](https://img.shields.io/nuget/v/PangLib.WEP.svg)](https://www.nuget.org/packages/PangLib.WEP/)               | [![Build status](https://github.com/retreev/panglib/actions/workflows/wep-build.yaml/badge.svg)](https://github.com/retreev/PangLib/actions/workflows/wep-build.yaml) | Library to handle and parse data from `.(g/sg/ai)bin` files |
